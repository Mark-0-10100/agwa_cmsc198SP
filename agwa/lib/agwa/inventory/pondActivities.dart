...
class _ActivitiesPageState extends State<ActivitiesPage> {
  ...
  DateTime taskDeadlineDate_controllerValue_temp = DateTime.now();
  late var taskDeadlineDate_controllerValue = DateTime.now();
  //For transaction page -------------------------------------------------------
              ...
              children: [
                ...
                DateTimeFormField(
                  ...
                  onDateSelected: (DateTime value) {
                    taskDeadlineDate_controllerValue_temp = value;
                  },
                ),
                SizedBox(height: 10),
                AnimatedButton(
                  ...
                  pressEvent: () {
                    if (_modalKey.currentState?.validate() ?? false) {
                      final transactionsData = TransactionsData(
                        ...
                        deadline_date: taskDeadlineDate_controllerValue_temp,
                        task_status: "true",
                      );
                      createTransactionsData(transactionsData);

                      taskDescription_controller.text = '';
                      taskDeadlineDate_controllerValue_temp = DateTime.now();
  ...
  Future<void> _update([DocumentSnapshot? documentSnapshot]) async {
    if (documentSnapshot != null) {
      ...
      Timestamp timestamp = documentSnapshot['Deadline'];
      DateTime taskDeadlineDate_controllerValue = timestamp.toDate();
      taskDeadlineDate_controller.text =
          taskDeadlineDate_controllerValue.toString();
    }
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                DateTimeFormField(
                  initialValue:
                      DateTime.parse(taskDeadlineDate_controller.text),
                  decoration: const InputDecoration(
                    hintStyle: TextStyle(color: Colors.black45),
                    errorStyle: TextStyle(color: Colors.redAccent),
                    border: OutlineInputBorder(),
